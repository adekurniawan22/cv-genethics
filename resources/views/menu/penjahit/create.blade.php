    ...
    <main class="page-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <span class="text-dark">Tambah Penjahit</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row ms-0 me-1">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    <form action="{{ route(session()->get('role') . '.penjahit.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="nama_penjahit" name="nama_penjahit"
                                ...
                                value="{{ old('nama_penjahit') }}" placeholder="Masukkan Nama Penjahit">
                            @error('nama_penjahit')
