            ...
            <div class="col-xl-12 col-lg-12 col-md-6">
                <div class="card radius-10 bg-purple-gradient">
                    <div
                        ...
                        <div class="d-flex align-items-center">
                            <a id="downloadPDF"
                                href="{{ route('manajer.dashboard.keuangan.pdf-report', ['year' => request('year', now()->year)]) }}"
...
@section('script')
    ...
    <script>
        ...
        function updateDownloadUrl() {
            ...
            downloadBtn.href = `{{ route('manajer.dashboard.keuangan.pdf-report', ['year' => ':year']) }}`.replace(':year',
                year);
        }
