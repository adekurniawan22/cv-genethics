    ...
    <main class="page-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <span class="text-dark">Edit Mesin</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row ms-0 me-1">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    <form action="{{ route(session()->get('role') . '.mesin.update', $mesin->mesin_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="nama_mesin" name="nama_mesin"
                                ...
                                value="{{ old('nama_mesin', $mesin->nama_mesin) }}" placeholder="Masukkan nama mesin">
                            @error('nama_mesin')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="status" name="status" class="form-select @error('status') is-invalid @enderror">
                                ...
                                <option value="aktif" {{ old('status', $mesin->status) == 'aktif' ? 'selected' : '' }}>
                                    Aktif</option>
                                <option value="tidak aktif"
                                    {{ old('status', $mesin->status) == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                            @error('status')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="keterangan_mesin" name="keterangan_mesin"
                                ...
                                value="{{ old('keterangan_mesin', $mesin->keterangan_mesin) }}"
                                placeholder="Masukkan keterangan mesin">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="kapasitas_per_hari" name="kapasitas_per_hari"
                                ...
                                value="{{ old('kapasitas_per_hari', $mesin->kapasitas_per_hari) }}"
                                placeholder="Masukkan kapasitas per hari">
