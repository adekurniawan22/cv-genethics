                        ...
                        <form action="{{ route('manajer.penjadwalan.index') }}" method="GET">
                            ...
                            <div class="row g-3 mb-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" name="limit" id="limit" class="form-control form-control-sm"
                                        placeholder="Jumlah data" value="{{ request('limit', 50) }}" min="1">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="jadwal-tab" data-bs-toggle="tab" data-bs-target="#jadwal"
                                type="button" role="tab" aria-controls="jadwal" aria-selected="true">Jadwal
                                Produksi</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="jadwal-mesin-tab" data-bs-toggle="tab"
                                data-bs-target="#jadwal-mesin" type="button" role="tab" aria-controls="jadwal-mesin"
                                aria-selected="false">Jadwal Produksi
                                per Mesin</button>
                        </li>
                    </ul>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="py-3 px-4 bg-dark text-white border-light text-center">Total</th>
