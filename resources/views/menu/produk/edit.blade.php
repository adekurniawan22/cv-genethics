    ...
    <main class="page-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <span class="text-dark">Edit Produk</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row ms-0 me-1">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    <form action="{{ route('owner.produk.update', $produk->produk_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="keterangan_produk" name="keterangan_produk"
                                ...
                                placeholder="Masukkan keterangan produk">{{ old('keterangan_produk', $produk->keterangan_produk) }}</textarea>
