...
<body>
    ...
    @php
        ...
        // Ambil data pengguna berdasarkan user_id dari session dengan relasi role
        $pengguna = Pengguna::where('pengguna_id', session('pengguna_id'))->first();
